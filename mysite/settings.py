...
SECRET_KEY = '$%-ab48i1+pb(@%*xsk*tx66l5yuu$csu9z!p3!2rs#vea*%yb'
...
# LDAP_AUTH_URL = "ldaps://sladp.iiita.ac.in"

# # Initiate TLS on connection.
# LDAP_USE_TLS = True

# # The LDAP search base for looking up users.
# LDAP_AUTH_SEARCH_BASE = "cn=test,ou=alumni,dc=iiita,dc=ac,dc=in"
...
# users_dn = 'ou=alumni,{}'.format(main_dn)
